...
type TourPackageBookingConfirmationPageProps = {
...
export function TourPackageBookingConfirmationPage({
  tourPackage,
}: TourPackageBookingConfirmationPageProps) {
  const t = useTranslation();
  const currentStep: TourPackageBookingStepId = "confirmation";
